    ...
    <MainLayout>
      <div className="surface w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="inline-flex items-center bg-slate-100 dark:bg-slate-800/60 rounded-xl p-1 gap-1">
            <button
            ...
            {user?.role !== 'admin' && (
              ...
              >
                ...
                {pendingUsers.length > 0 && (
                  <span className="min-w-[22px] h-[22px] px-1.5 rounded-full text-[11px] font-bold flex items-center justify-center bg-red-500 text-white">
                    {pendingUsers.length}
                  </span>
                )}
              </button>
                      ...
                      filteredRoles.map((role: any) => {
                        ...
                        return (
                          <tr key={role.id} className="hover:bg-slate-50/30 dark:hover:bg-slate-850/10 transition-colors">
                            ...
                            <td className="px-5 py-4">
                              {role.access_level ? (
                                <Badge className="bg-blue-50 text-blue-700 border border-blue-150 dark:bg-blue-950/20 dark:text-blue-300 dark:border-blue-900/30 text-[10px] font-bold">
                                  {role.access_level}
                                </Badge>
                              ) : (
            ...
            <form onSubmit={handleRoleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-500 dark:text-slate-400">Role Name *</Label>
                  <Input name="role_name" defaultValue={editingRole?.role_name || ""} placeholder="e.g. Site Manager" required className="text-xs bg-slate-50 border-slate-200 rounded-lg" />
                </div>
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-500 dark:text-slate-400">Role Code *</Label>
                  <Input name="role_code" defaultValue={editingRole?.role_code || ""} placeholder="SITE_MGR" required className="text-xs bg-slate-50 border-slate-200 rounded-lg" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select name="department" defaultValue={editingRole?.department_id || ""} className="w-full h-9 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 px-3 py-1 text-xs outline-none">
                ...
                <div className="space-y-1.5">
                  <Label className="text-xs font-semibold text-slate-500 dark:text-slate-400">Access Scope</Label>
                  <select name="access_level" defaultValue={editingRole?.access_level || ""} className="w-full h-9 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 px-3 py-1 text-xs outline-none">
                    <option value="">Select...</option>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <select name="dashboard_type" defaultValue={editingRole?.dashboard_type || ""} className="w-full h-9 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 px-3 py-1 text-xs outline-none">
                    <option value="">Select...</option>
              ...
              <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch checked={crossDeptAccess} onCheckedChange={setCrossDeptAccess} />
                </div>
              </div>
              ...
              <DialogFooter className="pt-4 border-t border-slate-100 dark:border-slate-800">
                ...
                <Button type="submit" className="bg-blue-600 hover:bg-blue-750 text-white text-xs font-semibold rounded-lg">
          ...
          <DialogContent className="max-w-md bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 rounded-xl">
            ...
            <form onSubmit={handleUserSubmit} className="space-y-5">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input name="name" defaultValue={editingUser?.name || ""} placeholder="e.g. Aarav Mehta" required className="text-xs bg-slate-50 border-slate-200 rounded-lg" />
                  </div>
                  <div className="space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <Input name="email" type="email" defaultValue={editingUser?.email || ""} placeholder="user@logicon.io" required className="text-xs bg-slate-50 border-slate-200 rounded-lg" />
                  </div>
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-550 dark:text-slate-400">Mobile</Label>
                    <Input name="mobile" defaultValue={editingUser?.profile?.phone_number || ""} placeholder="+91 98100 00000" className="text-xs bg-slate-50 border-slate-200 rounded-lg" />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <select name="department" defaultValue={editingUser?.profile?.department || ""} className="w-full h-9 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 px-3 py-1 text-xs outline-none font-medium text-slate-700">
                      <option value="">Select...</option>
                      {departments.map((d: any) => (
                        <option key={d.id} value={d.id}>{d.name}</option>
                      ))}
                  ...
                  <div className="space-y-1.5">
                    ...
                    <Input name="designation" defaultValue={editingUser?.profile?.designation || ""} placeholder="Designation Name" required className="text-xs bg-slate-50 border-slate-200 rounded-lg" />
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <Label className="text-xs font-semibold text-slate-550 dark:text-slate-400">Role</Label>
                    <select name="role" defaultValue={editingUser?.role || ""} className="w-full h-9 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 px-3 py-1 text-xs outline-none font-medium text-slate-700">
                      <option value="">Select...</option>
                      {roles.map((r: any) => (
                  ...
                  {user?.role === 'super_admin' && (
                    <div className="space-y-1.5">
                      <Label className="text-xs font-semibold text-slate-550 dark:text-slate-400">Site / Organization</Label>
                      <select name="site" defaultValue={editingUser?.profile?.site || ""} className="w-full h-9 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 px-3 py-1 text-xs outline-none font-medium text-slate-700">
                        <option value="">Select...</option>
                        {sites.map((s: any) => (
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <select name="reporting_manager" defaultValue={editingUser?.profile?.reporting_manager || ""} className="w-full h-9 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-50 px-3 py-1 text-xs outline-none font-medium text-slate-700">
                      <option value="">Select...</option>
              ...
              <div className="space-y-3 pt-3 border-t border-slate-100 dark:border-slate-800">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch name="is_active" defaultChecked={editingUser ? !!editingUser.is_active : true} />
                  </div>
                </div>
              </div>
              ...
              <DialogFooter className="pt-4 border-t border-slate-100 dark:border-slate-800">
                ...
                <Button type="submit" className="bg-blue-600 hover:bg-blue-755 text-white text-xs font-semibold rounded-lg">
